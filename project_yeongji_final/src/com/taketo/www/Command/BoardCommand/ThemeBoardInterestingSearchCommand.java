...
public class ThemeBoardInterestingSearchCommand implements Command {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int cnt = dao.getInterestingSearchCnt(interesting);
		int maxPage = dao.getMaxPage(cnt);
		if(maxPage < 0) {
			maxPage =0;
		}
		ArrayList<ThemeBoardDTO>searchResult =  dao.getSearchResultForInteresting(interesting,curPage);
